 ...
 *
 * \details Struct composed by the name of the command and a function prototype for the action to execute
 */
typedef struct
{
	const char *sc_name;
 ...
 *
 * \param ShellCommand_t *sc_command Shell command action pointer
 *
 */
typedef struct
{
 ...
 *
 * \details This data structure links the command to the corresponding action function.
 *
...
static ShellCommand_t ShellCommands[] =
{
	...
	{
		"encoder_pol", setEncoderPolarity
	},
	{
		NULL, NULL
		//(char *)0, (void **)0
